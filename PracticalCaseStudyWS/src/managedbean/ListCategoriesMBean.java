...
public class ListCategoriesMBean implements Serializable{
	...
	@EJB
	private CatalogFacadeRemoteJEE catalogRemote;		
	...
	{	
		...
		catalogRemote = (CatalogFacadeRemoteJEE) ctx.lookup("java:app/PracticalCaseStudyWS.jar/CatalogFacadeBeanJEE!ejb.CatalogFacadeRemoteJEE");
