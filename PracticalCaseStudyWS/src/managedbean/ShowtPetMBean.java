...
public class ShowtPetMBean implements Serializable{
	...
	@EJB
	private CatalogFacadeRemoteJEE showPetRemote;
	...
	{	
		...
		showPetRemote = (CatalogFacadeRemoteJEE) ctx.lookup("java:app/PracticalCaseStudyWS.jar/CatalogFacadeBeanJEE!ejb.CatalogFacadeRemoteJEE");
