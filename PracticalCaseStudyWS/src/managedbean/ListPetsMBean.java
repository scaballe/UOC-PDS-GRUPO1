...
public class ListPetsMBean implements Serializable{
	...
	@EJB
	private CatalogFacadeRemoteJEE petsRemote;
	...
	{	
		...
		screen = 0;
		petsRemote = (CatalogFacadeRemoteJEE) ctx.lookup("java:app/PracticalCaseStudyWS.jar/CatalogFacadeBeanJEE!ejb.CatalogFacadeRemoteJEE");
